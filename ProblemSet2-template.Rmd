...
(Note: the scatter plot of the raw data is eliminated since the explanatory variables are categorical variables which does not show a good visualization of the data)
